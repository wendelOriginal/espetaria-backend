...
var goods_controller_exports = {};
__export(goods_controller_exports, {
  GoodDeleteController: () => GoodDeleteController,
  GoodSearchController: () => GoodSearchController,
  GoodUpdateController: () => GoodUpdateController,
  GoodsCreateController: () => GoodsCreateController,
  GoodsGetController: () => GoodsGetController
});
module.exports = __toCommonJS(goods_controller_exports);
...
0 && (module.exports = {
  GoodDeleteController,
  GoodSearchController,
  GoodUpdateController,
  GoodsCreateController,
  GoodsGetController
});

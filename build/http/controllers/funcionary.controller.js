...
var funcionary_controller_exports = {};
__export(funcionary_controller_exports, {
  CreateFuncionaryController: () => CreateFuncionaryController,
  DeleteFuncionary: () => DeleteFuncionary,
  GetFuncionaries: () => GetFuncionaries,
  SearchFuncionary: () => SearchFuncionary,
  UpdateInformationFuncionary: () => UpdateInformationFuncionary
});
module.exports = __toCommonJS(funcionary_controller_exports);
...
0 && (module.exports = {
  CreateFuncionaryController,
  DeleteFuncionary,
  GetFuncionaries,
  SearchFuncionary,
  UpdateInformationFuncionary
});
